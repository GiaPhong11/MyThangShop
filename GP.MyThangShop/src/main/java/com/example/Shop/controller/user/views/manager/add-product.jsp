...
<html lang="en">
    ...
    <sf:form method="POST" action="${base}/admin/add-product" modelAttribute="product" enctype="multipart/form-data">
    	<%-- <sf:hidden path="id"/>  --%>
    ...
    <div class="col-md-12 ">
        <!-- <form class="register-form" role="form"> -->
            ...
            <sf:input path="price" type="number"  min="1" class="form-control unicase-form-control text-input" id="exampleInputTitle" placeholder="Price"/>
          </div>
        <!-- </form> -->
    </div>
    <div class="col-md-12">
        <div class="register-form" role="form">
            ...
            <sf:input path="priceSale" type="number"  min="1" class="form-control unicase-form-control text-input" id="exampleInputPriceSale" placeholder="Price sale"/>
          </div>
        </div>
    </div>
    <div class="col-md-12">
        <div class="register-form" role="form">
            <div class="form-group">
            <label class="info-title" for="exampleInputEmail1">SoLuongTon (required) </label>
            <sf:input path="soLuongTon" type="number" min="0" class="form-control unicase-form-control text-input" id="exampleInputPriceSale" placeholder="Price sale"/>
          </div>
        </div>
    </div>
    <div class="col-md-12">
