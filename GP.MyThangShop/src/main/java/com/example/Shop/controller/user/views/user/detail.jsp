	...
	<div class="container-fluid py-5">
		<div class="row px-xl-5">
				...
				<div id="product-carousel" class="carousel slide"
					...
					<div class="carousel-inner border">
						<div class="carousel-item active">
							<img class="w-100 h-100" src="${base }/upload/${pro.avatar}"
								alt="Image">
						</div>
						<c:forEach var="product" items="${product }">
						<div class="">
							<img class="w-100 h-100" src="${base }/upload/${product.path}">
						</div>
						</c:forEach>
					</div>
			...
			<div class="col-lg-7 pb-5">
				<h3 class="font-weight-semi-bold">${pro.title }</h3>
				...
				<p class="mb-4">${pro.shortDescription }</p>
				<!--  <div class="d-flex mb-3">
				...
				<div class="d-flex align-items-center mb-4 pt-2">
					<div class="input-group quantity mr-3" style="width: 130px;">
						...
						<input type="number" class="form-control bg-secondary text-center"
							value="1" id="number" min="1" name="soluong">
					...
					<button type="button" class="btn btn-primary px-3" onclick="addToCart(${pro.id},0)" >
						<i class="fa fa-shopping-cart mr-1"></i> Add To Cart
					</button>
				</div>
				Số lương sản phẩm tồn kho:
							<input type="text" class="form-control bg-secondary text-center" name="soluongton"
							value="${pro.soLuongTon }" style="margin-left: 30px;width: 150px" id="soluongton" readonly="readonly">	
...
<!-- 	<div class="container-fluid py-5">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                       <img class="img-fluid w-100" src="${base}/upload/${product2.avatar}" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">${product2.title}</h6>
                        <div class="d-flex justify-content-center">
                            <h6>${product2.price}</h6><h6 class="text-muted ml-2"><del>${product2.priceSale}</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="${base }/detail/${product2.id}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                        <a href="#" class="btn btn-sm text-dark p-0" onclick="addToCart2(${product2.id},1)"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</a>
                    </div>
                </div>
            </div>
           </c:forEach>
    ...
    <!-- <script type="text/javascript">
    	function changeSL(){
    		 var sp = document.getElementById("number").value; 
    		var soLuongTon = document.getElementById("soluongton").value;
    		alert("Sản phẩm: "+sp);
    		alert("Số lượng tồn: "+soLuongTon);
    		/* if(sp > soLuongTon){
	...
	<script type="text/javascript">
		 function addToCart2(productId,quanlity) {
			    let data = {
					productId: productId,
					quanlity:  quanlity		,
